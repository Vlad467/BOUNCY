...
var RadialProgress = function(size, barSize, barColor, backgroundColor, textColor, zIndex) { // jshint ignore:line
    ...
    document.getElementsByClassName('serv')[0].appendChild(this.radialProgress);
...
function createProgressOne() {
  var progress = new RadialProgress(120, 8, '#19bd9a', '#FFF', '#81868e', 10);


    progress.setProgress(80, 2);

}
function createProgressTwo() {
  var progress = new RadialProgress(120, 8, '#19bd9a', '#FFF', '#81868e', 10);
...
function createProgressThree() {
  var progress = new RadialProgress(120, 8, '#19bd9a', '#FFF', '#81868e', 10);


  progress.setProgress(60, 2);

}



$('.serv').viewportChecker({
...
$('.skillbar').viewportChecker({
  ...
  $('.progress-bar').each(function(){
   ...
   $(this).animate({width: data}, 4000);
  });

  }
});
$('.button-map').click(function(){
  $('.map-bg').animate({height: '0', padding: '0'}, 1000);
});